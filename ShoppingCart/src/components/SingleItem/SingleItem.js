...
import * as acionTypes from '../../redux/action'
...
const mapToDispatchProps = (dispatch) => {
  return{
    addToCart: (id) => dispatch({type:acionTypes.ADD_TO_CART, payload: {id:id}})
  }
}

export default connect(mapStateToProps,mapToDispatchProps)(SingleItem);